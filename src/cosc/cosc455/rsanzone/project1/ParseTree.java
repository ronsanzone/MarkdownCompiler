...
public class ParseTree {
    ...
    public static class ParseNode {
        ...
        public ParseNode(String data) {
            ...
            this.openingTag = NodeType.PLAIN_TEXT.getOpeningTag();
            this.closeingTag = NodeType.PLAIN_TEXT.getClosingTag();
            this.hasOpeningTag = NodeType.PLAIN_TEXT.hasOpeningTag();
            this.hasClosingTag = NodeType.PLAIN_TEXT.hasClosingTag();
            this.isText = NodeType.PLAIN_TEXT.isText();
            this.data = data;
